     ...
     <body style="background-image:url('./images/inbg.jpg');">
        <form id="adform" action="admsnform.php" method="post">
            <div class="container-fluid">    
                <div class="row">
                  <div class="col-sm-12">
                        <img src="images/cutm1.jpg" width="100%" style="box-shadow: 1px 5px 14px #999999; "></img>
                  </div>
                 </div>    
             </div>
            ...
            <table class="frmtbl">
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td><select id="oaco" name="oaco" required="true">
                           ...
                           <option>TANCET</option>
                            <option>GATE</option>
                            <option>SVNCET</option>
                            <option>JEE</option>
                        </select>
               ...
               <tr>
                    ...
                    <td><select id="brnc" name="brnc">
                         ...
                         <option>B.SC NANOTECHOLOGY</option>
                         <option>AL AND ML</option>
                         <option>P.E.T</option>
                         <option>M.SC YOGA</option>
                         <option>MBA</option>
                         </select>
                     </td>
               </tr>
           ...
           <tr>
                           ...
                           <tr>
                               ...
                               <td colspan="3">
                                    ...
                                    <input type="radio" id="moi" name="moi" value="Tamil"><font style="font-family: Verdana;">Tamil</font>
